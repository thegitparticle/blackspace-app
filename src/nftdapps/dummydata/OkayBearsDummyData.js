...
export const PrimaryDetailsOkayBears = {
  ...
  text_special_color: '#402d28',
};

export const MintPhasesOkayBears = [
  {
    start_timestamp: '1652620690',
    end_timestamp: '1652631490',
    phase_name: 'Whitelist Sale',
    phase_mint_price: '1.5',
    phase_mint_quantity: '7,400',
    phase_rules: '1 per wallet',
  },
  {
    start_timestamp: '1652631490',
    end_timestamp: '1652717890',
    phase_name: 'Public Sale',
    phase_mint_price: '1.5',
    phase_mint_quantity: '2,500',
    phase_rules: '1 per wallet',
  },
];
