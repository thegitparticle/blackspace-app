...
import IndexCoopProduct from '../products/indexcoopfunds/IndexCoopProduct';
...
function IndexFundsBluePrint() {
  ...
  function RenderProductIndexFunds({item, index}) {
    if (index === 0) {
      return (
  ...
  return (
    <View style={styles.parent_view}>
      <Carousel
        data={products}
        renderItem={RenderProductIndexFunds}
...
export default IndexFundsBluePrint;
